...
| miw.database.secret | string | `"{{ .Release.Name }}-postgresql"` | Existing secret name for the postgres user password |
| miw.database.secretPasswordKey | string | `"postgres-password"` | Existing secret key for the postgres user password |
