...
1. From `Managed_Identity_Wallet` collection run `Register self managed wallets` 
...
1. To Send another Credential Offer you can call `Managed_Identity_Wallet/Issuance-flow` and repeat the steps 8 to 11
