...
* Issuer get credential API testcases, test case modification for self_issued and is_stored ([1ff463d](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/1ff463d4167f7bc31d8603dfa8b29573118ef217))
* json web signature 2020 support added for did document, vc and vp ([a9838ce](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/a9838ce167a7f2d6a92849de66c8242e093a93b4))
* json web signature 2020 support added for did document, vc and vp ([ee5c25c](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/ee5c25cc76235f565f63ddd6329fd748f1055c02))
* json web signature 2020 support WIP ([62ee442](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/62ee442e799e59df0ed70925b71e419413a0bc9a))
* json web signature 2020 support WIP ([1785e97](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/1785e976487ad65a643fe3d29d1ac89c5c977ae3))
* json web signature and key generation from lib ([8fda456](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/8fda456a59e011f250677f2e929e6ffb14d1f5f9))
* json web signature and key generation from lib ([c29040b](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/c29040b6bfa8f76210fdb4f8223e835dc52c7d53))
* membership credentials api added ([45602c8](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/45602c8fe8db3a982ea9c644c180902ad512b75e))
* membership credentials api added ([b1a485a](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/b1a485ae379424dfbac71784c0283a6fd0a9be06))
* merge release 0.3.0 from main ([3305d2f](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/3305d2fe6bc303aebc6ea4b971318a102e60a202))
* Paggination support added in list VC API ([f4338fd](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/f4338fd1711e66b64db03f36f0a61c9d189ed70d))
* Paggination support added in list VC API ([b74c41c](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/b74c41cf95c949875f7802382e76eb328105d80d))
* **persistence:** add console logger to db init transaction (commented out, but useful for debugging) ([6706f18](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/6706f186ebb1343bf28dc8b59ff63a8a4d18fd7f))
* **persistence:** add console logger to db init transaction (commented out, but useful for debugging) ([0023056](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/00230568b67df4db2d8d5ba4ee02b2986a9dcdc1))
* **persistence:** adjust naming to snake_case and add suffixes ([720217f](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/720217fdfa650e2785a92708df688d8738bf04bc))
* **persistence:** adjust naming to snake_case and add suffixes ([d799a8d](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/d799a8d6987719b35fff1766c99896c0634b3af7))
* presenation API WIP, code refactor ([2c1b5d9](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/2c1b5d9c3bc667d8f91d1f35145bd3fb9c0c38c0))
* presenation API WIP, code refactor ([8cf8e83](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/8cf8e839bc3ca11b22f62d6678bb370a11474830))
* read me file chamges, sample reponse added ([88651fa](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/88651fa518fdcabf5ab1902d775d748a701df46e))
* read me file chamges, sample reponse added ([ff51983](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/ff51983713f407cd46cd2a71d31d81d294df56fb))
* readm changes and gradle fix ([79d5bf0](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/79d5bf04488477296c07c151b455623d7b023e58))
* readm changes and gradle fix ([a51127e](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/a51127ef4f70f3ce9285d08a8f12e6091f59df15))
* readme added, validate VP wip ([1c4d6af](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/1c4d6af2642b81e94430614ceb9ec4c2c3497da9))
* readme added, validate VP wip ([6325f8a](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/6325f8a59bd103e4dd63c779496c4ad317872f31))
* **readme:** add "usage" section [WIP] ([6919b71](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/6919b71870e9265ae09a66e3354ec43bf7d1d088))
* **readme:** adds overview of the required roles per endpoint ([391a7a7](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/391a7a7f4d4242a6390a8a13fa1a8329bb9a7d4e))
* reamdme added with env verables, vp as jwt, credentials id added in table, search with credential id ([524c537](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/524c5370aabd95e95b9c23eb902543394a0dbbb2))
* reamdme added with env verables, vp as jwt, credentials id added in table, search with credential id ([e654a57](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/e654a5744438cb32aac96ef405cb7f97a48554ba))
* remove commit link from changelog template ([bf8106e](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/bf8106e8903b239a804577b5c10d25586ae494ea))
* removed endpoint from config file ([93612f7](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/93612f791be46d2bb7de2022c47454495a986b9c))
* removed endpoint from config file ([b3e9f5f](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/b3e9f5f8724721f43540aef0e788725089c13a74))
* rename tasks from beginning with 'run' to beginning with 'start' to achieve a uniform 'start...' and 'stop...' appearance of task names. ([a3f3f1c](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/a3f3f1c4f9450cc436537672dc439a5e598ea0b5))
* rename tasks from beginning with 'run' to beginning with 'start' to achieve a uniform 'start...' and 'stop...' appearance of task names. ([7d59df4](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/7d59df41b902e4cdf16b2ab08fbf15a91c83e3a2))
* Resolve the DID document for a given DID or BPN api added ([1368edf](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/1368edfb1cef1cac0640b599bd8ba76b7e2aa627))
* Resolve the DID document for a given DID or BPN api added ([b5407e6](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/b5407e6f0068895a69986a6423aeedc9ed5f6af4))
* revert renaming and postpone that for later. ([3a63399](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/3a63399e80220bca2de0ed3bdcaf3b453b68c8fa))
* revert renaming and postpone that for later. ([3a9a209](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/3a9a209a6417e1eb7760c9f041b1952934d696e4))
* run Docker release on PR only on specific folders ([186104d](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/186104d46dbe3e84813e790e546214da2c6e5008))
* set health check actuator resp. liveliness probe endpoint to '/actuator/health/liveness' and readiness probe endpoint to '/actuator/health/readiness' both on port '8090' ([af44016](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/af44016dc3e04d5e7e1448007cb73a429c529de9))
* set health check actuator resp. liveliness probe endpoint to '/actuator/health/liveness' and readiness probe endpoint to '/actuator/health/readiness' both on port '8090' ([24c88be](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/24c88be0d644666951f928493a4df1b2aaebfffb))
* Spring security added with keycloak, Swagger added, Testcases modification based on spring security ([aed48ee](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/aed48ee4de89ab0df1d649260609db69264b6530))
* Spring security added with keycloak, Swagger added, Testcases modification based on spring security ([2345a33](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/2345a332e58262c3e49aba2cb9e7e3c2d97d1802))
* ssi lib v4 added, autority wallet config added ([1c5ee0e](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/1c5ee0e116bbc0ad69525da8cc7a3fbdfa67da4a))
* ssi lib v4 added, autority wallet config added ([57c8803](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/57c88033d6af4476ef951466f955777bdc4c6f9b))
* ssi-lib version set to 15 ([910aa2a](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/910aa2af97dc833da0b9b52fe463b1ca59e1afc3))
* ssi:lib version updated ([4939ddb](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/4939ddb2d9d4f4b982ffeb75279414b63d16a005))
* ssi:lib version updated ([404b65b](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/404b65bd325c09959cf79788972aebae6926347b))
* Store credential API with test case, Validate test case ([4911817](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/4911817dfdf40038cc2298d62676d4e2fa25c2b2))
* Store credential API with test case, Validate test case ([99307bf](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/99307bfb94b5f9294e9edce8b8f4b2522273ff08))
* Store credntial API, testcase mofitication based on DidDocument Java POJO ([569097b](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/569097b392d0fb7242ed9df47fcaf5fda40904b0))
* Store credntial API, testcase mofitication based on DidDocument Java POJO ([a0ca176](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/a0ca176a7e8b59da9120d2756f49ddb6ff0b7831))
* summary credential test cases added ([b322515](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/b322515b8b5ed1f9fa10f7cd0138820ba15a7e6e))
* summary credential test cases added ([0340efb](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/0340efb5496f6e83949a3094aade7b8f6b6f1bc2))
* summary VC context URL updated ([0cc6bfb](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/0cc6bfbd61d845689d6b0fe56214fd03b98bf0e6))
* summary VC context URL updated ([5a52c43](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/5a52c431684338fe9b69f543ee0425974726ce62))
* Summary VC flow, code changes as per input given in code review, test case changes as per summary VC flow ([07c4706](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/07c4706a8beb85313f325317e5feb9dca6bfff17))
* Summary VC flow, code changes as per input given in code review, test case changes as per summary VC flow ([50b6168](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/50b6168fedccd15076044a8a2aa03b3cdbd6d34f))
* summery VC flow after holder delete summary VC ([1b61f38](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/1b61f38c721ef961e4f6d5c97555a3dc49c1668d))
* summery VC flow after holder delete summary VC ([33135c1](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/33135c18b5de0734b26e9c0cb536860811299b13))
* swagger doc request example updated ([550cabb](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/550cabb1b945861e2e0a88f9e1688c6e9293ffe6))
* swagger doc updated as per new role in api and Retrieve wallet by identifier test cases updated ([330d207](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/330d207e239004340465ecfb34c606a658616c26))
* test case added for VC expiry check while VP validate as JWT ([e605d60](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/e605d608d9997796031f9831844bf8faec7616b9))
* test case of validate vc wip ([2123468](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/21234689065a7a39fc45a6d87ce40e7dc79e3ff2))
* test case of validate vc wip ([e4c2ff0](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/e4c2ff06c50ac7b348ec31231e02037fa2f2b110))
* test cases added for issueMembershipCredential api ([a3d19c1](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/a3d19c15ad59c57cd06f18fa5630e9555d639d10))
* test cases added for issueMembershipCredential api ([1666bcc](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/1666bccbfacef2ad423b00e4bc7d688f24bc994f))
* **test:** add Helm unittests for default values ([cc6d2bf](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/cc6d2bf32f711dd0b745e9e24c7bc73cb02cb5b3))
* **test:** add Helm unittests for default values ([c0f26e4](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/c0f26e4b47b36e300930b3178b4a5606a26a39c1))
* Testcase modification as per new API specification ([f29edb3](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/f29edb30ff9c651be10dc082ef6454fd293e7177))
* Testcase modification as per new API specification ([3990eee](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/3990eee105de860395011fc3a4e0cd7d490d7906))
* token support added in swagger ([cd74001](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/cd74001c323a54c4dcc9094daca42614c5826ff6))
* token support added in swagger ([813ce33](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/813ce3305035f66c34d4e696e1ed5819623d4c1f))
* Uncomment KC_HOSTNAME in env.docker.dist and env.local.dist (is required, not optional) ([aaeefc6](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/aaeefc61546d4ed3fa6fe0c91527e73d17068f45))
* update ditignore and dev.env added ([b90fe94](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/b90fe944a6f447e54349ff1ef99298d7fa9f2468))
* update ditignore and dev.env added ([6ff0555](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/6ff0555f77492f2420fca9ba18fa0087c700d5c8))
* update lib method to resolved vc/vp validate ([6f70b09](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/6f70b09523bed428472ed61c0c88964473a243b5))
* update lib method to resolved vc/vp validate ([1556d7c](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/1556d7c9e6b9f9449625f56503a9eb80b064a827))
* updated context url of did document and test case ([0b05e15](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/0b05e15bfd9e366d80c9004f0b3e9b5aea255438))
* updated create wallet api ([ba320ab](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/ba320ab31fbed0c833ffb8462b0b39c4a5ab3648))
* updated create wallet api ([c5ad2a1](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/c5ad2a12e0a44c1f7202d67044233264e546d427))
* updated credential get api ([1698996](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/16989967d67160ffbff6a0b9eae4d616634fd456))
* updated credential get api ([c6e2af4](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/c6e2af47a0e7b2fc6a0df4b9a68bb2c6dbaa512e))
* updated issuer credential api and test cases as per new api spec ([f33b056](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/f33b056c41584e65492b028cebb7f4a9f361d01d))
* updated issuer credential api and test cases as per new api spec ([921becf](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/921becf0d35597e4209cf6e2dc9e689c0ab2b8b0))
* updated issuer credential api and test cases as per new api spec ([c0f493b](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/c0f493b779175836ba98b774a7d025a0a3b96809))
* updated issuer credential api and test cases as per new api spec ([ff20227](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/ff2022747151fd887fcc712cfa3995d978b83fbc))
* updated store credential api ([74df138](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/74df138aa01417887e2bd439178f1e80b7be840a))
* updated store credential api ([f1e5289](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/f1e5289abe321a7c1153bbbb831035821bf2f1a4))
* updated swagger doc ([e6179d1](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/e6179d170da340dc7c1d192c516b28778e15fd30))
* updated swagger doc response sample and env file ([cba1d5f](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/cba1d5fff6dacc7cd09ec89f072bfc1fc9e083fd))
* updated vc type ([8b6ebfa](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/8b6ebfadbddabe9342b227e8043be110f7ae1ae1))
* updated vc type ([5acbea5](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/5acbea5c499a32a062819ec2987171efdff1391b))
* upload helm chart asset to GitHub release ([f7a1043](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/f7a1043d47b9da19c8030b3e5c16fcb8ee79eccd))
* validate issuer bpn while creating new wallet ([99b0117](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/99b0117c2c2ce71d6f69b22d528e41c2656feba4))
* validate VP and validate VC test cases updated with mock ([7531191](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/7531191afc62fba81d16aeef26b2ff0a84f20fd8))
* validate VP and validate VC test cases updated with mock ([26a91da](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/26a91da5234ac789515be501f5b6120e80e389c3))
* validate VP as jwt API, enforce https while did resolve in config, changes according to new lib ([235420f](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/235420fcd3eed36e575c10951bb067b0bb530e9a))
* validate VP as jwt API, enforce https while did resolve in config, changes according to new lib ([0339069](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/0339069c4c90baf4a27829e2fa56c809f76659e5))
* validation added in issue VC api for summary VC ([97ac189](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/97ac189d1e2ef13da12432c2e340d5b9140fa8cf))
* validation added in issue VC api for summary VC ([159637a](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/159637a3ce5787c4470b36275b14710aa79022a2))


### Reverts

* Revert "Release MIW 0.3.0 (#190)" (#193) ([28978a8](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/28978a8139b0bebe064224bfc29fccea795613af)), closes [#190](https://github.com/smartSenseSolutions/managed-identity-wallet/issues/190) [#193](https://github.com/smartSenseSolutions/managed-identity-wallet/issues/193)
* Revert "delete file" ([963d008](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/963d008feaaf7e3bbb98fbceb9d6debec353f345))
* Revert "enabling sqlite usage within scheduler" ([b33936f](https://github.com/smartSenseSolutions/managed-identity-wallet/commit/b33936f33d712aebd8c85068e72ef58a66dbb819))
