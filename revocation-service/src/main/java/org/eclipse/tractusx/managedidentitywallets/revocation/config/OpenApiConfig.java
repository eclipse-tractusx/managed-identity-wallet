...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        Info info = new Info();
        info.setTitle("Reovcation Service API");
        info.setDescription("Revocation Service API");
        info.setVersion("0.0.1");

        Contact contact = new Contact();
        contact.name("eclipse-tractusx");
    ...
    private OpenAPI enableSecurity(OpenAPI openAPI) {
        ...
        return openAPI
                ...
                .addSecurityItem(
                        new SecurityRequirement().addList(accessTokenAuth, Collections.emptyList()));
    }
}
