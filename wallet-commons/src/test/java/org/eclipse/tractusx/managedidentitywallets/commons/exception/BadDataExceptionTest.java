...
class BadDataExceptionTest {
    ...
    public static final String ERROR_MSG = "This is a bad data exception";
    ...
    void testConstructorWithMessageAndCause() {
        ...
        BadDataException exception = new BadDataException(message, cause);
        Assertions.assertEquals(message, exception.getMessage());
    ...
    void testConstructorWithCause() {
        Throwable cause = new IllegalArgumentException("Invalid argument");
        BadDataException exception = new BadDataException(cause);
