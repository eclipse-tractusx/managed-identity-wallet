...
> **IMPORTANT**: ssi-lib is resolving DID documents over the network. There are two endpoints that rely on this
> resolution:
...
| BITSTRING_STATUS_LIST_CONTEXT_URL | Context URI for bitstring status list                                                        | https://w3c.github.io/vc-bitstring-status-list/contexts/v1.jsonld                                                                                   |
|                                   |                                                                                              |                                                                                                                                                     |
