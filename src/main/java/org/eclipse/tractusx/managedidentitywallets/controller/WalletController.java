...
public class WalletController extends BaseController {
     ...
     */
    @Operation(summary = "Retrieve wallet by identifier", description = "Permission: **view_wallets** OR **view_wallet** (The BPN of Wallet to retrieve must equal the BPN of caller or Base wallet) \n\n Retrieve single wallet by identifier, with or without its credentials")
