...
public class PersistenceBeanConfig {
    ...
    @Bean
    public WalletRepository walletRepository(org.eclipse.tractusx.managedidentitywallets.dao.repository.WalletRepository walletRepo, WalletKeyRepository walletKeyRepo) {
